function Main_BSC_photoY_wetting3_L(lightOn,examineDay,examineDay2, pCO2frac, amountCations, avgT, alphaCO, pot1, plottt, indexS,maximumThreadt)
rng('shuffle')
...
serial_id_new = sprintf('HT_BSC_photoY3_L_Day%dPot%.1fpCO2frac%dCat%.1favT%dAlphaCO%dfindex%d',examineDay,pot1,pCO2frac,amountCations,avgT,alphaCO, indexS);
cd(serial_id_new);
load('Final.mat')
if lightOn == 1   
...
%%% Wetting for two days (immersed in water)
