...
mumax = 3*[10 10 10 10 10 1.6 1 1]/(24*60*60); %Maximum specific growth rate, unit: (s-1)
...
%  
% Balanced equation using TEEM_2 : 
% [ fe = 0.45 ] [ fs = 0.55 ] [ e = 0.5 ]
% + 0.0417 C6H12O6 + 0.1131 O2 + 0.0233 NH4+ + 0.0233 HCO3- --> 0.1372 C'1'H'2.5'O'1'N'0.17 + 0 H+ + 0 e- + 0.1361 CO2 + 0.1368 H2O  
%  
% Yield prediction :
% Yg/m = 108.391 [ grams_cells/mol_donor ]
% Yc/m = 3.293 [ mol_C_cells/mol_donor ]
% Yc/c = 0.549 [ mol_C_cell/mol_C_donor ]

a = [0.0417*6 0.1131 0.0233 0.0233 0.1372 0.1361 0.1368];
Y = a(5); 
...
Ks = [KsPh1;KsPh2;KsPh3;KsPh4;oxygenK 0 0.88 HeteroKs 0 1.7*10^(-6) 0;-1*oxygenK 0 0 HeteroKs 0.0022 0 0; 0.49918 0.88 0.88 0 0 1.2150 0; 0.49918 0.88 0 0 0 0 4.920];%Nitrobactor's Ks value for NO2- has been used
