function [efflux, sitesC, sitesCg, sitesC2] = EquilibriumConcentrationDensity_Domain(waterVolume,gasVolume,sitesC,sitesC2,sitesCg,HenryDomain,InvasedIsland,AlphaM,sitesNEquil,sitesNGEquil,changeN,iniConcentrationGas)
