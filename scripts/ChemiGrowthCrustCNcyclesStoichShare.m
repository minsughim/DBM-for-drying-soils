function [apparentGrowth5, apparentGrowth6, apparentGrowth7,apparentGrowth8] = ChemiGrowthCrustCNcyclesStoichShare(sitesC,sitesC2,MumaxT,nutShare)
...
compNH3 = nutShare(:,:,6).*sitesN./(Ks(5,6)+sitesN);
...
compNH3 = nutShare(:,:,6).*sitesN./(Ks(7,6)+sitesN);
...
compNO2 = nutShare(:,:,7).*sitesNIII./(Ks(8,7)+sitesNIII);
