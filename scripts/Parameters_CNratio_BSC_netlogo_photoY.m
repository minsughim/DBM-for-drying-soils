...
O2 = Molwt(2)/Y; %O2
NH4 = 0;  %NH4+
CO2 = -1*6.15*Molwt(7)/Y; %CO2
H2O = -1*5.645*Molwt(8)/Y; %H2O
CH2O = 6*Molwt(1)/Y;
HCO3 = 0;
NO3 =  -1*0.095*Molwt(4)/Y;
N2 = 0;
H = 6.51/Y;
NO2 = 0;
N2O = 0;
Yph1 = [O2 CO2 HCO3 CH2O NO3 NH4 NO2 N2O N2 H2O H]/Molwt(9)/30.7322;

% %a1CO2 +a2H2O+a3NH4+ =YCH2.5ON0.17+a4CH2O+ O2 +a5H+
O2 = Molwt(2)/Y; %O2
NH4 = -0.095*a(3)*Molwt(11)/Y;  %NH4+
CO2 = -1*6.15*Molwt(7)/Y; %CO2
H2O = -1*5.2*Molwt(8)/Y; %H2O
CH2O = 6*Molwt(1)/Y;
HCO3 = 0;
NO3 =  0;
N2 = 0;
...
NO2 = 0;
N2O = 0;
Yph2 = [O2 CO2 HCO3 CH2O NO3 NH4 NO2 N2O N2 H2O H]/Molwt(9)/30.7322;

% %a1HCO3 +a2H2O+a3NO3- =YCH2.5ON0.17+a4CH2O+ O2 +a5H+
O2 = Molwt(2)/Y; %O2
NH4 = 0;  %NH4+
CO2 = 0; %CO2
H2O = 0.595*Molwt(8)/Y; %H2O
CH2O = 6*Molwt(1)/Y;
HCO3 = -1*6.15*Molwt(10)/Y;
NO3 =  -1*0.095*Molwt(4)/Y;
N2 = 0;
H = -1*7.84/Y;
NO2 = 0;
N2O = 0;
Yph3 = [O2 CO2 HCO3 CH2O NO3 NH4 NO2 N2O N2 H2O H]/Molwt(9)/30.7322;

%a1HCO3- +a2H2O+a3NH4+ =YCH2.5ON0.17+a4CH2O+ O2 +a5H+
O2 = Molwt(2)/Y; %O2
NH4 = -0.095*a(3)*Molwt(11)/Y;  %NH4+
CO2 = 0; %CO2
H2O = 0.3*Molwt(8)/Y; %H2O
CH2O = 6*Molwt(1)/Y;
HCO3 = -1*6.15*Molwt(10)/Y;
NO3 =  0;
N2 = 0;
...
NO2 = 0;
N2O = 0;
Yph4 = [O2 CO2 HCO3 CH2O NO3 NH4 NO2 N2O N2 H2O H]/Molwt(9)/30.7322;
