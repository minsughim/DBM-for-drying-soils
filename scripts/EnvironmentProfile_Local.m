function [intensityList,temperatureList,MumaxT, HenryConstListO2,HenryConstListCO2,HenryConstListNH3, HenryConstListHONO, HenryConstListN2O, pKList] = EnvironmentProfile_Local(depthList,timeLine,alphaMatrix,averageT, amplitudeT, attenuationRate, MaximumIncidence);
...
for i = 1:tempT
    for j = 1:tempL
        ...
        tTemp = timeLine(i);
        dampD = dampingD(j);
        temperatureTemp = averageT + amplitudeT.*exp(-zTemp./dampD).*sin((2*pi*(tTemp-6)/24)-(zTemp./dampD));
