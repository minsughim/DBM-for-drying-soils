...
nh3 = 20;
%[0.1 5 10 15]
VariableShift(1,:) = [5 3 1 0.1 25 nh3 hono 7];
VariableShift(2,:) = [5 3 1 0.1 25 nh3 hono 8];
...
serial_id2 = sprintf('HT_BSC_photoY3_H2ONO_NH3%d_HONO%d_Drying%d',NH3ppb, HONOppb, desiccationIndex);
