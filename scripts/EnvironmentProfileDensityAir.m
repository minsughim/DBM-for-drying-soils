function [intensityList,temperatureList,MumaxT, HenryConstListO2,HenryConstListCO2,HenryConstListNH3, HenryConstListHONO, HenryConstListN2O, pKList,Density_air] = EnvironmentProfileDensityAir(depthList,timeLine,alphaMatrix)
