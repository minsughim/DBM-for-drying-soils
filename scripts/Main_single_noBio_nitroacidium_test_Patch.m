function [sitesC2ini, sitesCaini, sitesCgini, sitesCini, sitesH2ONOini, waterFilm, LocalGasContents] = Main_single_noBio_nitroacidium_test_Patch(PartialPressure,amountCations,nitrateF,avgT, pot1)
rng('shuffle')
...
% Nitroacidium
sitesCnitroacidium = 10^(-10)*ones(m,n);
