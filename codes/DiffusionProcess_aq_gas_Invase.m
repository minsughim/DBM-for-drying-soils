function Diffresult = DiffusionProcess_aq_gas_Invase(diffMatrixInd,waterFilm,waterVolume,gasVolume,sitesCin,sitesCgin,HenryDomainin,reactionCin,InvasedIsland,sitesNEquilin,sitesNGEquilin,AlphaMin,listE,Lp,dt,testMinT)
