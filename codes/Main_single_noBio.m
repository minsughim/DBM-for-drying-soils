...
iniConcentration(4) = 26.9958*initMoles; % N5 : SS initMoles M (readily degradable organic substrate) : CH1.5O0.5N0.1 %Initmole only controls the sugar concentraion. (Catillo-Monroy 2010): 34.61mg/kg soil: with porosity 0.3: 34.61*2.6*0.3~
iniConcentration(5) = 2*frac; % N2 : NO3- : H (Abed 2013, for hot desert with lots of nitrate)
iniConcentration(6) = 0.88*18/14; % NH4+ johnson2005relevance
iniConcentration(7) = 2*frac; %NO2- same as NO3- to start with
